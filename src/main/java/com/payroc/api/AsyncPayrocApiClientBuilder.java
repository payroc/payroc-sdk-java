...
import com.payroc.api.core.InferredAuthTokenSupplier;
import com.payroc.api.core.LogConfig;
...
public class AsyncPayrocApiClientBuilder {
     ...
     * Sets apiKey
     */
    public AsyncPayrocApiClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncPayrocApiClientBuilder environment(Environment environment) {
     ...
     */
    public AsyncPayrocApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncPayrocApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncPayrocApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncPayrocApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncPayrocApiClientBuilder addHeader(String name, String value) {
    ...
    public AsyncPayrocApiClient build() {
        validateConfiguration();
        return new AsyncPayrocApiClient(buildClientOptions());
    }
}
