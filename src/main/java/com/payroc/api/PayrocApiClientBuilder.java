...
public class PayrocApiClientBuilder {
     ...
     * Sets apiKey
     */
    public PayrocApiClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public PayrocApiClientBuilder environment(Environment environment) {
     ...
     */
    public PayrocApiClientBuilder timeout(int timeout) {
     ...
     */
    public PayrocApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public PayrocApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public PayrocApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public PayrocApiClientBuilder addHeader(String name, String value) {
    ...
    public PayrocApiClient build() {
        validateConfiguration();
        return new PayrocApiClient(buildClientOptions());
    }
}
