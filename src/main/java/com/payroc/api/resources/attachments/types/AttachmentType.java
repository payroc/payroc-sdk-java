...
public final class AttachmentType {
    public static final AttachmentType OTHER = new AttachmentType(Value.OTHER, "other");
    ...
    public static final AttachmentType QUESTIONNAIRES_AND_LICENSES =
            new AttachmentType(Value.QUESTIONNAIRES_AND_LICENSES, "questionnairesAndLicenses");

    private final Value value;

    private final String string;

    AttachmentType(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof AttachmentType && this.string.equals(((AttachmentType) other).string));
    }
    ...
    public static AttachmentType valueOf(String value) {
        switch (value) {
            case "other":
                return OTHER;
            case "taxDocuments":
            ...
            default:
                return new AttachmentType(Value.UNKNOWN, value);
        }
    }
