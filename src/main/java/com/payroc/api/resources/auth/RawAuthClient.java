...
public class RawAuthClient {
     ...
     */
    public PayrocApiHttpResponse<GetTokenResponse> retrieveToken(RetrieveTokenAuthRequest request) {
     ...
     * Obtain an access token using client credentials
     */
    public PayrocApiHttpResponse<GetTokenResponse> retrieveToken(
