...
public class RawMerchantPlatformsClient {
    protected final ClientOptions clientOptions;

    public RawMerchantPlatformsClient(ClientOptions clientOptions) {
     ...
     */
    public PayrocApiHttpResponse<PayrocPager<MerchantPlatform>> list() {
     ...
     */
    public PayrocApiHttpResponse<MerchantPlatform> create(CreateMerchantAccount request) {
    ...
    public PayrocApiHttpResponse<MerchantPlatform> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayrocApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, MerchantPlatform.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<MerchantPlatform> retrieve(String merchantPlatformId) {
        return retrieve(
     ...
     */
    public PayrocApiHttpResponse<PayrocPager<ProcessingAccount>> listProcessingAccounts(String merchantPlatformId) {
    ...
    public PayrocApiHttpResponse<PayrocPager<ProcessingAccount>> listProcessingAccounts(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            if (response.isSuccessful()) {
                PaginatedProcessingAccounts parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedProcessingAccounts.class);
                return new PayrocApiHttpResponse<>(
                        PayrocPager.create(parsedResponse, clientOptions, requestOptions), response);
            }
            try {
     ...
     */
    public PayrocApiHttpResponse<ProcessingAccount> createProcessingAccount(
