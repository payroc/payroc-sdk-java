...
public class AsyncProcessingTerminalsClient {
    protected final ClientOptions clientOptions;

    private final AsyncRawProcessingTerminalsClient rawClient;

    public AsyncProcessingTerminalsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new AsyncRawProcessingTerminalsClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public AsyncRawProcessingTerminalsClient withRawResponse() {
     ...
     * </ul>
     */
    public CompletableFuture<ProcessingTerminal> retrieve(String processingTerminalId) {
        return this.rawClient.retrieve(processingTerminalId).thenApply(response -> response.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<ProcessingTerminal> retrieve(String processingTerminalId, RequestOptions requestOptions) {
        return this.rawClient.retrieve(processingTerminalId, requestOptions).thenApply(response -> response.body());
    }
     ...
     * </ul>
     */
    public CompletableFuture<ProcessingTerminal> retrieve(
            String processingTerminalId, RetrieveProcessingTerminalsRequest request) {
        return this.rawClient.retrieve(processingTerminalId, request).thenApply(response -> response.body());
    }
     ...
     */
    public CompletableFuture<HostConfiguration> retrieveHostConfiguration(String processingTerminalId) {
        return this.rawClient.retrieveHostConfiguration(processingTerminalId).thenApply(response -> response.body());
    }
     ...
     * <p>Our gateway returns the configuration settings for the merchant and the payment terminal.</p>
     */
    public CompletableFuture<HostConfiguration> retrieveHostConfiguration(
