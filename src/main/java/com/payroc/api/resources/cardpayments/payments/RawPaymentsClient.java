...
public class RawPaymentsClient {
     ...
     */
    public PayrocApiHttpResponse<PayrocPager<RetrievedPayment>> list() {
     ...
     * <p>For each transaction, we also return the paymentId and an optional secureTokenId, which you can use to perform follow-on actions.</p>
     */
    public PayrocApiHttpResponse<PayrocPager<RetrievedPayment>> list(RequestOptions requestOptions) {
     ...
     * <p>For each transaction, we also return the paymentId and an optional secureTokenId, which you can use to perform follow-on actions.</p>
     */
    public PayrocApiHttpResponse<PayrocPager<RetrievedPayment>> list(ListPaymentsRequest request) {
    ...
    public PayrocApiHttpResponse<PayrocPager<RetrievedPayment>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaymentPaginatedListForRead parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaymentPaginatedListForRead.class);
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<Payment> create(PaymentRequest request) {
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<Payment> create(PaymentRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getApiURL())
                .newBuilder()
                .addPathSegments("payments");
        if (requestOptions != null) {
     ...
     */
    public PayrocApiHttpResponse<RetrievedPayment> retrieve(String paymentId) {
     ...
     * <p>If the merchant saved the customer's card details, our gateway returns a secureTokenID, which you can use to perform follow-on actions.</p>
     */
    public PayrocApiHttpResponse<RetrievedPayment> retrieve(String paymentId, RequestOptions requestOptions) {
     ...
     * <p>If the merchant saved the customer's card details, our gateway returns a secureTokenID, which you can use to perform follow-on actions.</p>
     */
    public PayrocApiHttpResponse<RetrievedPayment> retrieve(String paymentId, RetrievePaymentsRequest request) {
     ...
     * <p>If the merchant saved the customer's card details, our gateway returns a secureTokenID, which you can use to perform follow-on actions.</p>
     */
    public PayrocApiHttpResponse<RetrievedPayment> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayrocApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RetrievedPayment.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
     ...
     */
    public PayrocApiHttpResponse<Payment> adjust(String paymentId, PaymentAdjustment request) {
     ...
     * <p>Our gateway returns information about the adjusted payment, including information about the payment card and the cardholder.</p>
     */
    public PayrocApiHttpResponse<Payment> adjust(
     ...
     */
    public PayrocApiHttpResponse<Payment> capture(String paymentId, PaymentCapture request) {
     ...
     * <p><strong>Note:</strong> For more information about pre-authorizations and captures, go to <a href="https://docs.payroc.com/guides/integrate/run-a-pre-authorization">Run a pre-authorization</a>.</p>
     */
    public PayrocApiHttpResponse<Payment> capture(
