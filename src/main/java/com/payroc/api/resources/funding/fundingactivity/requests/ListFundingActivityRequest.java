...
@JsonDeserialize(builder = ListFundingActivityRequest.Builder.class)
public final class ListFundingActivityRequest {
    ...
    private ListFundingActivityRequest(
    ...
    /**
     * @return Filter by activity after a specific date. Send a value in <strong>YYYY-MM-DD</strong> format.
     */
    ...
    /**
     * @return Filter by activity before a specific date. Send a value in <strong>YYYY-MM-DD</strong> format.
     */
    @JsonProperty("dateTo")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListFundingActivityRequest && equalTo((ListFundingActivityRequest) other);
    }
    ...
    private boolean equalTo(ListFundingActivityRequest other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.before, this.after, this.limit, this.dateFrom, this.dateTo, this.merchantId);
    }
    ...
    public interface DateFromStage {
        /**
         * <p>Filter by activity after a specific date. Send a value in <strong>YYYY-MM-DD</strong> format.</p>
         */
        DateToStage dateFrom(@NotNull LocalDate dateFrom);

        Builder from(ListFundingActivityRequest other);
    }

    public interface DateToStage {
        /**
         * <p>Filter by activity before a specific date. Send a value in <strong>YYYY-MM-DD</strong> format.</p>
         */
    ...
    public static final class Builder implements DateFromStage, DateToStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListFundingActivityRequest other) {
