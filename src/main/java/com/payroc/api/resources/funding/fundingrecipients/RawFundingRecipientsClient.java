...
public class RawFundingRecipientsClient {
    protected final ClientOptions clientOptions;

    public RawFundingRecipientsClient(ClientOptions clientOptions) {
     ...
     */
    public PayrocApiHttpResponse<PayrocPager<FundingRecipient>> list() {
     ...
     */
    public PayrocApiHttpResponse<FundingRecipient> create(CreateFundingRecipient request) {
    ...
    public PayrocApiHttpResponse<FundingRecipient> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayrocApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FundingRecipient.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<FundingRecipient> retrieve(int recipientId) {
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<Void> update(int recipientId, UpdateFundingRecipientsRequest request) {
     ...
     * <p><strong>Note</strong>: If you don't have the recipientId, use our <a href="https://docs.payroc.com/api/schema/funding/funding-recipients/list">List Funding Recipients</a> method to search for the funding recipient.</p>
     */
    public PayrocApiHttpResponse<Void> delete(int recipientId) {
     ...
     */
    public PayrocApiHttpResponse<List<FundingAccount>> listAccounts(int recipientId) {
        return listAccounts(
                recipientId,
     ...
     */
    public PayrocApiHttpResponse<List<Owner>> listOwners(int recipientId) {
        return listOwners(
    ...
    public PayrocApiHttpResponse<List<Owner>> listOwners(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayrocApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<List<Owner>>() {}),
                        response);
            }
            try {
                switch (response.code()) {
     ...
     */
    public PayrocApiHttpResponse<Owner> createOwner(int recipientId, CreateOwnerFundingRecipientsRequest request) {
