...
public class RawEventSubscriptionsClient {
    protected final ClientOptions clientOptions;

    public RawEventSubscriptionsClient(ClientOptions clientOptions) {
     ...
     */
    public PayrocApiHttpResponse<PayrocPager<EventSubscription>> list() {
    ...
    public PayrocApiHttpResponse<PayrocPager<EventSubscription>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                PaginatedEventSubscriptions parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedEventSubscriptions.class);
     ...
     */
    public PayrocApiHttpResponse<EventSubscription> create(CreateEventSubscriptionsRequest request) {
    ...
    public PayrocApiHttpResponse<EventSubscription> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayrocApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, EventSubscription.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<Void> update(int subscriptionId, UpdateEventSubscriptionsRequest request) {
     ...
     */
    public PayrocApiHttpResponse<Void> delete(int subscriptionId) {
