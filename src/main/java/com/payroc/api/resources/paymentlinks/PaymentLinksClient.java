...
public class PaymentLinksClient {
     ...
     * </ul>
     */
    public RetrievePaymentLinksResponse retrieve(String paymentLinkId, RequestOptions requestOptions) {
        return this.rawClient.retrieve(paymentLinkId, requestOptions).body();
    }
     ...
     * <p>If your request is successful, our gateway deactivates the payment link. The customer can't use the link to make a payment, and you can't reactivate the payment link.</p>
     */
    public DeactivatePaymentLinksResponse deactivate(String paymentLinkId, RequestOptions requestOptions) {
        return this.rawClient.deactivate(paymentLinkId, requestOptions).body();
    }
