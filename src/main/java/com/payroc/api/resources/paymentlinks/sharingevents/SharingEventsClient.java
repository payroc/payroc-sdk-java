...
public class SharingEventsClient {
    protected final ClientOptions clientOptions;

    private final RawSharingEventsClient rawClient;

    public SharingEventsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new RawSharingEventsClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public RawSharingEventsClient withRawResponse() {
     ...
     * </ul>
     */
    public PayrocPager<PaymentLinkEmailShareEvent> list(String paymentLinkId) {
        return this.rawClient.list(paymentLinkId).body();
    }
     ...
     * </ul>
     */
    public PayrocPager<PaymentLinkEmailShareEvent> list(String paymentLinkId, RequestOptions requestOptions) {
        return this.rawClient.list(paymentLinkId, requestOptions).body();
    }
     ...
     * </ul>
     */
    public PayrocPager<PaymentLinkEmailShareEvent> list(String paymentLinkId, ListSharingEventsRequest request) {
        return this.rawClient.list(paymentLinkId, request).body();
    }
     ...
     * </ul>
     */
    public PayrocPager<PaymentLinkEmailShareEvent> list(
            String paymentLinkId, ListSharingEventsRequest request, RequestOptions requestOptions) {
        return this.rawClient.list(paymentLinkId, request, requestOptions).body();
    }
     ...
     */
    public PaymentLinkEmailShareEvent share(String paymentLinkId, ShareSharingEventsRequest request) {
        return this.rawClient.share(paymentLinkId, request).body();
    }
     ...
     * <p>In the response, our gateway returns a sharingEventId, which you can use to <a href="https://docs.payroc.com/api/schema/payment-links/sharing-events/list">List Payment Link Sharing Events</a>.</p>
     */
    public PaymentLinkEmailShareEvent share(
            String paymentLinkId, ShareSharingEventsRequest request, RequestOptions requestOptions) {
        return this.rawClient.share(paymentLinkId, request, requestOptions).body();
    }
}
