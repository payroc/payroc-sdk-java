...
public class AsyncPaymentInstructionsClient {
    protected final ClientOptions clientOptions;

    private final AsyncRawPaymentInstructionsClient rawClient;

    public AsyncPaymentInstructionsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new AsyncRawPaymentInstructionsClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public AsyncRawPaymentInstructionsClient withRawResponse() {
     ...
     * </ul>
     */
    public CompletableFuture<PaymentInstruction> submit(String serialNumber, PaymentInstructionRequest request) {
     ...
     * </ul>
     */
    public CompletableFuture<PaymentInstruction> submit(
     ...
     */
    public CompletableFuture<PaymentInstruction> retrieve(String paymentInstructionId) {
        return this.rawClient.retrieve(paymentInstructionId).thenApply(response -> response.body());
    }
     ...
     * <p>To cancel a payment instruction, you need its paymentInstructionId. Our gateway returned the paymentInstructionId in the response of the <a href="https://docs.payroc.com/api/schema/payroc-cloud/payment-instructions/submit">Submit Payment Instruction</a> method.</p>
     */
    public CompletableFuture<Void> delete(String paymentInstructionId, DeletePaymentInstructionsRequest request) {
        return this.rawClient.delete(paymentInstructionId, request).thenApply(response -> response.body());
    }
    ...
    public CompletableFuture<Void> delete(
        ...
        return this.rawClient
                .delete(paymentInstructionId, request, requestOptions)
                .thenApply(response -> response.body());
    }
}
