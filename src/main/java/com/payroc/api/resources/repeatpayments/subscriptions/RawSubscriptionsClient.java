...
public class RawSubscriptionsClient {
     ...
     */
    public PayrocApiHttpResponse<PayrocPager<Subscription>> list(String processingTerminalId) {
     ...
     * <p>For each subscription, we also return the subscriptionId, the paymentPlanId, and the secureTokenId, which you can use to perform follow-actions.</p>
     */
    public PayrocApiHttpResponse<PayrocPager<Subscription>> list(
    ...
    public PayrocApiHttpResponse<PayrocPager<Subscription>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                SubscriptionPaginatedList parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SubscriptionPaginatedList.class);
     ...
     */
    public PayrocApiHttpResponse<Subscription> create(String processingTerminalId, SubscriptionRequest request) {
     ...
     * <p>You can also update the settings that the subscription inherited from the payment plan, for example, you can change the amount for each payment. If you change the settings for the subscription, it doesn't change the settings in the payment plan that it's linked to.</p>
     */
    public PayrocApiHttpResponse<Subscription> create(
     ...
     */
    public PayrocApiHttpResponse<Subscription> retrieve(String processingTerminalId, String subscriptionId) {
        return retrieve(
     ...
     * <p>We also return the paymentPlanId and the secureTokenId, which you can use to perform follow-on actions.</p>
     */
    public PayrocApiHttpResponse<Subscription> retrieve(
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<Subscription> partiallyUpdate(
     ...
     */
    public PayrocApiHttpResponse<Subscription> deactivate(String processingTerminalId, String subscriptionId) {
        return deactivate(
                processingTerminalId,
                subscriptionId,
     ...
     * <p>To reactivate the subscription, use our <a href="https://docs.payroc.com/api/schema/payments/subscriptions/reactivate">Reactivate Subscription</a> method.</p>
     */
    public PayrocApiHttpResponse<Subscription> deactivate(
     ...
     */
    public PayrocApiHttpResponse<Subscription> reactivate(String processingTerminalId, String subscriptionId) {
        return reactivate(
                processingTerminalId,
                subscriptionId,
     ...
     * <p>To deactivate the subscription, use our <a href="https://docs.payroc.com/api/schema/repeat-payments/subscriptions/deactivate">Deactivate Subscription</a> method.</p>
     */
    public PayrocApiHttpResponse<Subscription> reactivate(
     ...
     */
    public PayrocApiHttpResponse<SubscriptionPayment> pay(
    ...
    public PayrocApiHttpResponse<SubscriptionPayment> pay(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayrocApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SubscriptionPayment.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
