...
public class RawSettlementClient {
    protected final ClientOptions clientOptions;

    public RawSettlementClient(ClientOptions clientOptions) {
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<PayrocPager<Batch>> listBatches(ListReportingSettlementBatchesRequest request) {
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<PayrocPager<Batch>> listBatches(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListBatchesSettlementResponse parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListBatchesSettlementResponse.class);
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<Batch> retrieveBatch(int batchId) {
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<Transaction> retrieveTransaction(int transactionId) {
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<Authorization> retrieveAuthorization(int authorizationId) {
    ...
    public PayrocApiHttpResponse<Authorization> retrieveAuthorization(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayrocApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Authorization.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<PayrocPager<Dispute>> listDisputes(ListReportingSettlementDisputesRequest request) {
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<PayrocPager<Dispute>> listDisputes(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            if (response.isSuccessful()) {
                ListDisputesSettlementResponse parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListDisputesSettlementResponse.class);
                return new PayrocApiHttpResponse<>(
                        PayrocPager.create(parsedResponse, clientOptions, requestOptions), response);
            }
            try {
     ...
     */
    public PayrocApiHttpResponse<List<DisputeStatus>> listDisputesStatuses(int disputeId) {
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<PayrocPager<AchDeposit>> listAchDeposits(
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<AchDeposit> retrieveAchDeposit(int achDepositId) {
