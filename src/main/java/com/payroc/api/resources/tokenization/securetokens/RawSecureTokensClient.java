...
public class RawSecureTokensClient {
    protected final ClientOptions clientOptions;

    public RawSecureTokensClient(ClientOptions clientOptions) {
     ...
     */
    public PayrocApiHttpResponse<PayrocPager<SecureTokenWithAccountType>> list(String processingTerminalId) {
     ...
     */
    public PayrocApiHttpResponse<SecureToken> create(String processingTerminalId, TokenizationRequest request) {
    ...
    public PayrocApiHttpResponse<SecureTokenWithAccountType> retrieve(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PayrocApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SecureTokenWithAccountType.class),
                        response);
            }
            try {
                switch (response.code()) {
     ...
     */
    public PayrocApiHttpResponse<Void> delete(String processingTerminalId, String secureTokenId) {
        return delete(
                processingTerminalId,
                secureTokenId,
     ...
     * </ul>
     */
    public PayrocApiHttpResponse<SecureToken> partiallyUpdate(
                ...
                switch (response.code()) {
                    ...
                    case 413:
                        throw new ContentTooLargeError(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FourHundredThirteen.class),
                                response);
                    case 415:
                        throw new UnsupportedMediaTypeError(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FourHundredFifteen.class),
