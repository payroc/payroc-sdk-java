...
public class SecureTokensClient {
    protected final ClientOptions clientOptions;

    private final RawSecureTokensClient rawClient;

    public SecureTokensClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
        this.rawClient = new RawSecureTokensClient(clientOptions);
    }

    /**
     * Get responses with HTTP metadata like headers
     */
    public RawSecureTokensClient withRawResponse() {
     ...
     */
    public PayrocPager<SecureTokenWithAccountType> list(String processingTerminalId) {
     ...
     * <p>For each secure token, we also return the secureTokenId, which you can use to perform follow-on actions.</p>
     */
    public PayrocPager<SecureTokenWithAccountType> list(
     ...
     */
    public SecureToken create(String processingTerminalId, TokenizationRequest request) {
     ...
     * <p>If the request is successful, our gateway returns a token that the merchant can use in transactions instead of the customer's sensitive payment details, for example, when they <a href="https://docs.payroc.com/api/schema/card-payments/payments/create">run a sale</a>.</p>
     */
    public SecureToken create(String processingTerminalId, TokenizationRequest request, RequestOptions requestOptions) {
        return this.rawClient
     ...
     * </ul>
     */
    public SecureTokenWithAccountType retrieve(String processingTerminalId, String secureTokenId) {
        return this.rawClient.retrieve(processingTerminalId, secureTokenId).body();
    }
     ...
     * <p>When you delete a secure token, you can’t recover it, and you can’t reuse its identifier for a new token.</p>
     */
    public void delete(String processingTerminalId, String secureTokenId, DeleteSecureTokensRequest request) {
        this.rawClient.delete(processingTerminalId, secureTokenId, request).body();
    }
     ...
     * </ul>
     */
    public SecureToken partiallyUpdate(
