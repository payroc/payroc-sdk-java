...
public final class TokenizationRequestMitAgreement {
    ...
    TokenizationRequestMitAgreement(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof TokenizationRequestMitAgreement
                        && this.string.equals(((TokenizationRequestMitAgreement) other).string));
    }
    ...
    public static TokenizationRequestMitAgreement valueOf(String value) {
        switch (value) {
            ...
            case "unscheduled":
                return UNSCHEDULED;
            default:
                return new TokenizationRequestMitAgreement(Value.UNKNOWN, value);
        }
    }
