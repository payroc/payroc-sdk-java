...
public final class Notification {
    ...
    private Notification(Value value) {
        this.value = value;
    }
    ...
    public static Notification webhook(Webhook value) {
        return new Notification(new WebhookValue(value));
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof Notification && value.equals(((Notification) other).value);
    }
    ...
    public interface Visitor<T> {
        T visitWebhook(Webhook webhook);

        T _visitUnknown(Object unknownType);
    }

    @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "type", visible = true, defaultImpl = _UnknownValue.class)
    @JsonSubTypes(@JsonSubTypes.Type(WebhookValue.class))
    ...
    private static final class WebhookValue implements Value {
        ...
        private WebhookValue(Webhook value) {
            this.value = value;
        }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "Notification{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
