...
public final class PaymentInstruction implements IDeviceInstruction {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentInstruction && equalTo((PaymentInstruction) other);
    }
    ...
    private boolean equalTo(PaymentInstruction other) {
        return status.equals(other.status)
                && errorMessage.equals(other.errorMessage)
                && link.equals(other.link)
                && paymentInstructionId.equals(other.paymentInstructionId);
    }

    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.status, this.errorMessage, this.link, this.paymentInstructionId);
    }
