...
@JsonDeserialize(builder = PricingAgreementUs50Processor.Builder.class)
public final class PricingAgreementUs50Processor {
    private final Optional<PricingAgreementUs50ProcessorCard> card;

    private final Optional<Ach> ach;

    private final Map<String, Object> additionalProperties;

    private PricingAgreementUs50Processor(
            Optional<PricingAgreementUs50ProcessorCard> card,
            Optional<Ach> ach,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PricingAgreementUs50Processor && equalTo((PricingAgreementUs50Processor) other);
    }
    ...
    private boolean equalTo(PricingAgreementUs50Processor other) {
    ...
    public static final class Builder {
        private Optional<PricingAgreementUs50ProcessorCard> card = Optional.empty();
        ...
        public Builder from(PricingAgreementUs50Processor other) {
            card(other.getCard());
            ach(other.getAch());
            return this;
        }
        ...
        public Builder card(PricingAgreementUs50ProcessorCard card) {
        ...
        public PricingAgreementUs50Processor build() {
            return new PricingAgreementUs50Processor(card, ach, additionalProperties);
        }
    }
}
