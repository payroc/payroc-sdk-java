...
public final class ProcessingTerminalTimezone {
    public static final ProcessingTerminalTimezone PACIFIC_HONOLULU =
            new ProcessingTerminalTimezone(Value.PACIFIC_HONOLULU, "Pacific/Honolulu");
    ...
    ProcessingTerminalTimezone(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof ProcessingTerminalTimezone
                        && this.string.equals(((ProcessingTerminalTimezone) other).string));
    }
    ...
    public static ProcessingTerminalTimezone valueOf(String value) {
        switch (value) {
